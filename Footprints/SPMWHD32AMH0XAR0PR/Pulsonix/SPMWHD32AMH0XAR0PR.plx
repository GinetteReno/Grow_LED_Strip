...
(library Library_1
	...
	(compDef "SPMWHD32AMH0XAR0PR" (originalName "SPMWHD32AMH0XAR0PR") (compHeader (numPins 4) (numParts 1) (refDesPrefix LED)
		...
		(compPin "2" (pinName "A_1") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "3" (pinName "K_2") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "4" (pinName "A_2") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "https://download.led.samsung.com/led/file/resource/2022/05/Data_Sheet_LM301H_EVO_Rev.2.1.pdf")
		(attr "<Component Height>" "0.8")
		(attr "<STEP Filename>" "SPMWHD32AMH0XAR0PR.stp")
